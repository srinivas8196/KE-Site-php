...
$fetch['preferred_destination'] = "Karma Experience";
...
function send_email($name_first, $name_last, $email, $SingleLine, $price, $tranid)
{
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "New Karma Experience Booking received from $name_first through www.karmaexperience.com";
        $mail->Body = "
                ...
                <strong>Website:</strong> https://karmaexperience.com/payment/pay-now/ <br> 
            ";
...
// Redirect to the return URL with query parameters
$returnUrl = 'http://localhost/payment/thank-you.php';
$returnUrl .= '?name_first=' . urlencode($name_first);
$returnUrl .= '&name_last=' . urlencode($name_last);
$returnUrl .= '&email=' . urlencode($email);
$returnUrl .= '&SingleLine=' . urlencode($SingleLine);
$returnUrl .= '&price=' . urlencode($price);
$returnUrl .= '&tranid=' . urlencode($tranid);
