...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Process is_active field: if the checkbox is checked, it will be set; otherwise, it isn’t.
    ...
    if (isset($_POST['resort_id']) && !empty($_POST['resort_id'])) {
        // Update existing resort – now including is_active
        ...
        // Insert new resort – including is_active
