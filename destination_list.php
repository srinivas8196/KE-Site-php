    ...
    <main class="flex-1 p-8">
      ...
      <nav class="mb-4 text-sm text-gray-600" aria-label="Breadcrumb">
        <ol class="list-reset flex">
          ...
          <li class="text-gray-600">Destinations</li>
        </ol>
      </nav>
      <h2 class="text-3xl font-bold mb-6">Destinations List</h2> <br>
      <a href="create_destination.php" class="bg-blue-500 text-white px-4 py-2 rounded">Create New Destination</a> <br> <br>

      <?php if(count($destinations) > 0): ?>
        <table class="min-w-full bg-white border border-gray-200">
          <thead></thead>
            <tr>
              <th class="py-2 px-4 border-b">Destination Name</th>
          ...
          <tbody></tbody>
            ...
            <tr></tr>
              <td class="py-2 px-4 border-b"><?php echo htmlspecialchars($destination['destination_name']); ?></td>
              <td class="py-2 px-4 border-b">
                <a href="edit_destination.php?id=<?php echo $destination['id']; ?>" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit</a>
                <a href="delete_destination.php?id=<?php echo $destination['id']; ?>" class="bg-red-500 text-white px-2 py-1 rounded" onclick="return confirm('Are you sure you want to delete this destination?');">Delete</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
